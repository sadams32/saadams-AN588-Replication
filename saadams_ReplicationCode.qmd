...
```{r}
f_male <- curl("https://raw.githubusercontent.com/sadams32/saadams-AN588-Replication/refs/heads/main/Espeset2021_AnEntSoc_1.csv")

d_male <- read.csv(f, header = TRUE, sep = ",", stringsAsFactors = FALSE)

f_female <- curl("https://raw.githubusercontent.com/sadams32/saadams-AN588-Replication/refs/heads/main/Espeset2021_AnEntSoc_2.csv")

d_female <- read.csv(f, header = TRUE, sep = ",", stringsAsFactors = FALSE)
```
